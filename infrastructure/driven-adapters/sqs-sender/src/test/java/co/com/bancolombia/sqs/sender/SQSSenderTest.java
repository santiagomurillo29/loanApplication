...
public class SQSSenderTest {
    ...
    @Test
    void shouldSendStateMessageAndReturnMessageId() throws Exception {
        LoanApplicationState state = new LoanApplicationState(1L, "APPROVED", "example@example.com", "STATUS");
        LoanApplicationStateDto stateDto = new LoanApplicationStateDto(1L, "APPROVED", "example@example.com", "STATUS");
